...
class ParseClient: NSObject {
    ...
    // MARK: GETing a student location
    ...
    // MARK: GETing student locations
    
    func taskForGETingStudentLocations(completionHandlerForGET:@escaping (_ data: Data?, _ error: Error?) -> Void) {
        ...
        let task = session.dataTask(with: request) { data, response, error in
            ...
            func sendError(_ error: String) {
                print(error)
                let userInfo = [NSLocalizedDescriptionKey : error]
                completionHandlerForGET(nil, NSError(domain: "taskForGETStudentLocations", code: 1, userInfo: userInfo))
            }
    ...
    // MARK: POSTing a student locatiom

    func taskForPOSTingAStudentLocation(jsonBody: String, completionHandlerForPOST: @escaping (_ data: Data?, _ error: Error?) -> Void) -> URLSessionDataTask {
        
        // Build the URL, Configure the request */
        var request = NSMutableURLRequest(url: URL(string: ParseClient.Constants.BaseURL)!)
    ...
    // MARK: PUTing a student location
    
    func taskForPUTtingAStudentLocation(jsonBody: String, completionHandlerForPUT: @escaping (_ data: Data?, _ error: Error?) -> Void) -> URLSessionDataTask {
